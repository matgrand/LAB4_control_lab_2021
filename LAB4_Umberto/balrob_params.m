...
mot.w0 = 350*30*rpm2rads;               % no ́load speed @ nom voltage
mot.I0 = 0.3;                           % no ́load current @ nom voltage
mot.R = mot.UN/mot.Is;                  % armature resistance
mot.L = NaN;                            % armature inductance
mot.Kt = mot.taus/mot.Is;               % torque constant
mot.Ke = (mot.UN-mot.R*mot.I0)/(mot.w0);% back ́EMF constant
...
chassis.yb = 0;                             % CoM y-pos in body frame
chassis.zb = 80e-3;                         % CoM z-pos in body frame
